        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr v-for="user in users.data" :key="user.id">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        ...
                                        :class="user.is_admin ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'">
                                            {{ user.is_admin ? 'Admin' : 'User' }}
                                        </span>
                                    </td>

                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <button @click="confirmUserDeletion(user)" class="text-red-500 hover:text-red-900 hover:underline">Delete</button>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <jet-dialog-modal :show="confirmingUserDeletion" @close="confirmingUserDeletion = false">
                    ...
                    <template #content>
                        Are you sure you want to delete this user? Once the account is deleted, it will be permanently deleted.
                    </template>
